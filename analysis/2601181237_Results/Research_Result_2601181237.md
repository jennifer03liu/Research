...
|------:|---------------:|---------:|---------------:|----------------:|---------:|---------:|---------:|---------:|---------:|----------:|--------:|--------:|---------:|:-------------------------|:-------------------------------------------|
|   424 |            465 | 1149.86  |              0 |         6327.46 | 0.876186 | 0.818275 | 0.800703 | 0.818275 | 0.864213 | 0.0660003 | 138.163 | 424.46  |  2.91842 | Model_1_5Factors         | 原始五因子模型 (HP, JCP, PP, DP, CI)       |
|   428 |            465 | 2211.78  |              0 |         6327.46 | 0.695728 | 0.650447 | 0.620229 | 0.650447 | 0.669424 | 0.10298   | 124.773 | 395.165 |  5.61366 | Model_2_4Factors_CP      | 四因子: 合併階層與工作內容停滯 (CP=HP+JCP) |
|   269 |            300 |  860.908 |              0 |         5480.68 | 0.885747 | 0.842919 | 0.824817 | 0.842919 | 0.87258  | 0.0748264 | 107.63  | 330.306 |  2.18505 | Model_3_4Factors_NoPP    | 四因子: 排除主動型人格 (No PP)             |
|   272 |            300 | 1911.89  |              0 |         5480.68 | 0.68346  | 0.651158 | 0.615248 | 0.651158 | 0.650875 | 0.123859  |  96.295 | 307.042 |  4.85252 | Model_4_3Factors_CP_NoPP | 三因子: 合併CP且排除PP (CP, DP, CI)        |
|   293 |            325 |  908.663 |              0 |         5104.54 | 0.871188 | 0.821989 | 0.802548 | 0.821989 | 0.85712  | 0.0731209 | 111.387 | 342.016 |  2.30625 | Model_5_4Factors_NoDP    | 四因子: 排除決策拖延 (No DP)               |
|   296 |            325 | 1966.97  |              0 |         5104.54 | 0.650391 | 0.614663 | 0.57691  | 0.614663 | 0.616139 | 0.119851  | 100.015 | 318.715 |  4.99231 | Model_6_3Factors_CP_NoDP | 三因子: 合併CP且排除DP (CP, PP, CI)        |
...
|:-------------------------|:-------------------------------------------|------:|---------:|---------:|----------:|--------:|--------:|
| Model_1_5Factors         | 原始五因子模型 (HP, JCP, PP, DP, CI)       |   424 | 0.876186 | 0.864213 | 0.0660003 | 138.163 | 424.46  |
| Model_2_4Factors_CP      | 四因子: 合併階層與工作內容停滯 (CP=HP+JCP) |   428 | 0.695728 | 0.669424 | 0.10298   | 124.773 | 395.165 |
| Model_3_4Factors_NoPP    | 四因子: 排除主動型人格 (No PP)             |   269 | 0.885747 | 0.87258  | 0.0748264 | 107.63  | 330.306 |
| Model_4_3Factors_CP_NoPP | 三因子: 合併CP且排除PP (CP, DP, CI)        |   272 | 0.68346  | 0.650875 | 0.123859  |  96.295 | 307.042 |
| Model_5_4Factors_NoDP    | 四因子: 排除決策拖延 (No DP)               |   293 | 0.871188 | 0.85712  | 0.0731209 | 111.387 | 342.016 |
| Model_6_3Factors_CP_NoDP | 三因子: 合併CP且排除DP (CP, PP, CI)        |   296 | 0.650391 | 0.616139 | 0.119851  | 100.015 | 318.715 |

## 🚀 模型優化建議 (Optimization Suggestions)
以下項目的因素負荷量偏低 (< 0.60)，建議可嘗試刪除以提升模型適配度 (如 CFI)。
| Model                    | lval   | rval   |    Est. Std | p-value                |
|:-------------------------|:-------|:-------|------------:|:-----------------------|
| Model_5_4Factors_NoDP    | JCP6   | JCP    | -0.0633255  | 0.2279664931737746     |
| Model_1_5Factors         | JCP6   | JCP    | -0.0631021  | 0.2295482664663422     |
| Model_3_4Factors_NoPP    | JCP6   | JCP    | -0.0581397  | 0.26838089213773797    |
| Model_2_4Factors_CP      | JCP6   | CP     | -0.00530483 | 0.9208356718015738     |
| Model_6_3Factors_CP_NoDP | JCP6   | CP     | -0.00529188 | 0.921024083306643      |
| Model_4_3Factors_CP_NoPP | JCP6   | CP     | -0.00246545 | 0.9631484397926655     |
| Model_4_3Factors_CP_NoPP | JCP5_R | CP     |  0.146672   | 0.005990438510935725   |
| Model_2_4Factors_CP      | JCP5_R | CP     |  0.148177   | 0.0055102116830549885  |
| Model_6_3Factors_CP_NoDP | JCP5_R | CP     |  0.148198   | 0.005500870769857169   |
